      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
        <div className="col-span-1 md:col-span-2">
          ...
          <p className="text-stone-400 max-w-sm text-lg">
            Brewing stories, one cup at a time. Join us on a journey of flavor,
            tradition, and warmth.
          </p>
        </div>

        <div>
          <h4 className="text-xl font-bold text-amber-100 mb-6 font-['Patrick_Hand']">
            Quick Links
          </h4>
        ...
        <div>
          ...
          <form
            className="flex border-b border-stone-600 pb-2"
          ...
          >
            ...
            />
            <button className="text-orange-500 hover:text-orange-400 font-bold">
              →
            </button>
          </form>
        </div>
